      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row items-center justify-between">
          ...
          <div className="flex space-x-6 mb-4 md:mb-0 order-3 md:order-2">
            ...
            <a 
              href="https://www.dextools.io/app/en/solana/pair-explorer/DYZopjL34W4XpxbZaEjsCsXsrt6HbgE8WMCmPF1oPCwM?t=1764828062438" 
              target="_blank" 
              rel="noopener noreferrer" 
              className="text-gray-500 hover:text-primary"
              aria-label="DEXTools"
            >
              <svg 
                ...
                aria-hidden="true"
              >
                <path clipRule="evenodd" d={DEXTOOLS_PATH_DATA} fillRule="evenodd" />
              </svg>
            </a>
            
            <a 
              href="https://dexscreener.com/solana/DYZopjL34W4XpxbZaEjsCsXsrt6HbgE8WMCmPF1oPCwM" 
              target="_blank" 
              rel="noopener noreferrer" 
              className="text-gray-500 hover:text-primary"
